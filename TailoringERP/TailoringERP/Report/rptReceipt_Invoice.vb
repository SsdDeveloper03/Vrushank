...
Public Class rptReceipt_Invoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptReceipt_Invoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CashBank() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptReceipt_Invoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceipt_Invoice = New rptReceipt_Invoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
