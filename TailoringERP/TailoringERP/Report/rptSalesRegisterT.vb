...
Public Class rptSalesRegisterT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptSalesRegisterT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesRegisterT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesRegisterT = New rptSalesRegisterT()
        rpt.Site = Me.Site
        Return rpt
    End Function
