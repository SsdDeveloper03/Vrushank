...
Public Class rptInvoiceRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptInvoiceRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_GSTIN() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptInvoiceRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvoiceRegister = New rptInvoiceRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
