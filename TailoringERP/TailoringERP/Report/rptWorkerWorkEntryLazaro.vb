...
Public Class rptWorkerWorkEntryLazaro
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptWorkerWorkEntryLazaro.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptWorkerWorkEntryLazaro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWorkerWorkEntryLazaro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWorkerWorkEntryLazaro = New rptWorkerWorkEntryLazaro()
        rpt.Site = Me.Site
        Return rpt
    End Function
