...
Public Class rptInvoiceWfs1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptInvoiceWfs1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvoiceWfs1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvoiceWfs1 = New rptInvoiceWfs1()
        rpt.Site = Me.Site
        Return rpt
    End Function
