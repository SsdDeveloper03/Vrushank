...
Public Class rptWorkerWiseWIP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptWorkerWiseWIP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWorkerWiseWIP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWorkerWiseWIP = New rptWorkerWiseWIP()
        rpt.Site = Me.Site
        Return rpt
    End Function
