...
Public Class rptBarcode_Allwin
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptBarcode_Allwin.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBarcode_Allwin
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBarcode_Allwin = New rptBarcode_Allwin()
        rpt.Site = Me.Site
        Return rpt
    End Function
