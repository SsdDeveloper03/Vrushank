...
Public Class rptJobworkChallan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptJobworkChallan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptJobworkChallan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptJobworkChallan = New rptJobworkChallan()
        rpt.Site = Me.Site
        Return rpt
    End Function
