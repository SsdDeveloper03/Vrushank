...
Public Class rptEvogue_Shirt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptEvogue_Shirt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEvogue_Shirt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEvogue_Shirt = New rptEvogue_Shirt()
        rpt.Site = Me.Site
        Return rpt
    End Function
