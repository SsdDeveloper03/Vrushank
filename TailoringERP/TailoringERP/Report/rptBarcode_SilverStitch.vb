...
Public Class rptBarcode_SilverStitch
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptBarcode_SilverStitch.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptBarcode_SilverStitch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBarcode_SilverStitch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBarcode_SilverStitch = New rptBarcode_SilverStitch()
        rpt.Site = Me.Site
        Return rpt
    End Function
