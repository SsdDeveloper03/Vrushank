...
Public Class rptBarcode_Parampara
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptBarcode_Parampara.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptBarcode_Parampara.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_VendorCode() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptBarcode_Parampara
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBarcode_Parampara = New rptBarcode_Parampara()
        rpt.Site = Me.Site
        Return rpt
    End Function
