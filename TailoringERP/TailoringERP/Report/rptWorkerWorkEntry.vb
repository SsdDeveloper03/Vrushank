...
Public Class rptWorkerWorkEntry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptWorkerWorkEntry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWorkerWorkEntry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWorkerWorkEntry = New rptWorkerWorkEntry()
        rpt.Site = Me.Site
        Return rpt
    End Function
