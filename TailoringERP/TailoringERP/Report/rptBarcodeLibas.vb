...
Public Class rptBarcodeLibas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptBarcodeLibas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBarcodeLibas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBarcodeLibas = New rptBarcodeLibas()
        rpt.Site = Me.Site
        Return rpt
    End Function
