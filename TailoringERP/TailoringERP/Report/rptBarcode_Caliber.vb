...
Public Class rptBarcode_Caliber
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptBarcode_Caliber.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBarcode_Caliber
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBarcode_Caliber = New rptBarcode_Caliber()
        rpt.Site = Me.Site
        Return rpt
    End Function
