...
Public Class rptBookingDelivery
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptBookingDelivery.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBookingDelivery
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBookingDelivery = New rptBookingDelivery()
        rpt.Site = Me.Site
        Return rpt
    End Function
