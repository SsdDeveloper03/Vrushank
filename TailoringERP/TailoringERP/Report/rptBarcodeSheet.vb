...
Public Class rptBarcodeSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptBarcodeSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBarcodeSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBarcodeSheet = New rptBarcodeSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
