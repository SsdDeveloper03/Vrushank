...
Public Class rptBankReceipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptBankReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBankReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBankReceipt = New rptBankReceipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
