...
Public Class rptImageSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptImageSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptImageSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImageSheet = New rptImageSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
