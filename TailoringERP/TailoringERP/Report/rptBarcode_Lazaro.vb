...
Public Class rptBarcode_Lazaro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptBarcode_Lazaro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBarcode_Lazaro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBarcode_Lazaro = New rptBarcode_Lazaro()
        rpt.Site = Me.Site
        Return rpt
    End Function
