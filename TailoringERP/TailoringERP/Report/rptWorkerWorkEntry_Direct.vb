...
Public Class rptWorkerWorkEntry_Direct
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptWorkerWorkEntry_Direct.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptWorkerWorkEntry_Direct.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptWorkerWorkEntry_Direct
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptWorkerWorkEntry_Direct = New rptWorkerWorkEntry_Direct()
        rpt.Site = Me.Site
        Return rpt
    End Function
