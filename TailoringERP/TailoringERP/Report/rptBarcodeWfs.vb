...
Public Class rptBarcodeWfs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptBarcodeWfs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBarcodeWfs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBarcodeWfs = New rptBarcodeWfs()
        rpt.Site = Me.Site
        Return rpt
    End Function
