...
Public Class rptPurchaseRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptPurchaseRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPurchaseRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPurchaseRegister = New rptPurchaseRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
