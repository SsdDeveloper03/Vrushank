...
Public Class rptBarcode_Libas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptBarcode_Libas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBarcode_Libas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBarcode_Libas = New rptBarcode_Libas()
        rpt.Site = Me.Site
        Return rpt
    End Function
