...
Public Class rptBarcode_Salrio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunrise.rptBarcode_Salrio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBarcode_Salrio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBarcode_Salrio = New rptBarcode_Salrio()
        rpt.Site = Me.Site
        Return rpt
    End Function
